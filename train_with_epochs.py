...
from utils import loadData, make_batches

batchSize=2
device = torch.device('cuda') if torch.cuda.is_available() else torch.device('cpu')   # train on the GPU or on the CPU, if a GPU is not available

dataset, cats = loadData("/home/rogdenis/segmentation/Gastro.v1i.coco-segmentation/train")
#print(dataset[0][1])
train_data = make_batches(dataset, batchSize)
val_dataset, cats_val = loadData("/home/rogdenis/segmentation/Gastro.v1i.coco-segmentation/valid", cats=cats)
